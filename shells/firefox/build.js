...
const main = async () => {
  ...
  console.log('yarn run start:firefox');
  ...
  console.log('yarn run start:firefox -- --firefox=beta');
  console.log(chalk.gray('\n# You can test against older versions too:'));
  console.log('yarn run start:firefox -- --firefox=/Applications/Firefox52.app/Contents/MacOS/firefox-bin');
};
